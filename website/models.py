...
class OutgoingFiles(db.Model):
    ...
    pnj = db.Column(db.Boolean, default=False)
    assmt = db.Column(db.Boolean, default=False)
    vat = db.Column(db.Boolean, default=False)
    wht = db.Column(db.Boolean, default=False)
    coll = db.Column(db.Boolean, default=False)
