        ...
        try:
            ...
            if form.mail_letter.data:
                ...
                new_appointment = InboundMails(
                    ...
                    recipient="Admin Name"  # Set recipient as admin name
                )
                print("Here 1")
            ...
            if form.vat.data:
                ...
                new_vat = VAT(
                    ...
                    company_address=form.company_address.data,
                    contact_number=form.contact_number.data,
                    amount=form.vat_amount.data,  # Use form data for VAT amount
                    ...
                    date=form.appointment_date.data  # Set date to the appointment date
                )
                print("Here 2")
            ...
            if form.annual_return.data:
                ...
                new_annual_return = AnnualReturns(
                    date_return_received=form.appointment_date.data,  # Set return received date
                    tin=form.company_tin.data,
                    company_name=form.company_name.data,
